<x-app-layout>
    <div class="py-8 flex flex-col justify-center items-center">
        ...
        <div class="space-y-8 lg:divide-y lg:divide-gray-100 w-full md:max-w-md lg:max-w-2xl xl:max-w-5xl">
            ...
            <div class="group relative sm:flex lg:items-end rounded-lg shadow-lg hover:bg-gray-100">
                <div class="mb-4 shrink-0 sm:mb-0 sm:mr-4">
                    <img class="h-32 w-full rounded-md object-cover lg:w-32" src="{{ asset('storage/' . $postList->imag_url) }}" alt="{{$postList->spotTitle}}" />
                </div>
                <div>
